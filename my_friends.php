		...
		<div class="content">
			...
			<div id="user_timeline">
				...
				echo "
					 ...
					 <p><a href='my_friends.php?u_id=$user_id' style='text-decoration:underline'>My Friends</a> </p>
			...
			<div id="content_timeline"><br/>
				<h2 id="welcome_header"><?php echo $user_name;?>'s friend list:</h2><br/><br/>
				<?php frnd_request_process();?>
				<?php user_friend_list(); ?>							
			</div>
